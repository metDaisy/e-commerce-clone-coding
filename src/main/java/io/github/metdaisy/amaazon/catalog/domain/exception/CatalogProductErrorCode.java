...
public enum CatalogProductErrorCode implements AmaazonErrorCode {
  ...
  PRODUCT_CODE_ERROR("CATALOG-006", "상품 식별자 오류가 있습니다. 필드별 메시지를 확인해 주세요.", "상품 식별자 검증 또는 중복 실패", AmaazonErrorType.BAD_REQUEST),
  ...
  IDENTIFIER_INVALID("CATALOG-014", "식별자 형식 또는 체크디지트를 확인해 주세요.", "CatalogProduct 식별자 형식 검증 실패", AmaazonErrorType.BAD_REQUEST),
  ISBN_EXTERNAL_VERIFICATION_FAILED("CATALOG-015", "ISBN 외부 검증에 실패했습니다.", "ISBN 외부 검증 실패", AmaazonErrorType.BAD_REQUEST),
