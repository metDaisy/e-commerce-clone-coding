...
새 graph와 validator는 현재 `board-contract`만 사용한다. 과거 contract가 필요한 경우 Git
history에서 확인한다. 이 계약은 repository HEAD/planning SHA, application-covered snapshot freshness,
