...
flowchart LR
    ...
    subgraph Catalog["P2 상품 / 카탈로그 / 판매"]
        ...
        Review["<b>Review</b><br/>id<br/>catalogProduct<br/>user<br/>rating<br/>content<br/>createdAt"]
        Wishlist["<b>Wishlist</b><br/>id<br/>user<br/>catalogProduct<br/>createdAt"]

        Category -->|"parent ↔ childCategories<br/>1 : N"| Category
        Category -->|"catalogProducts ↔ category<br/>1 : N"| CatalogProduct
        CatalogProduct -->|"variants ↔ catalogProduct<br/>1 : N"| ProductVariant
        ProductVariant -->|"offers ↔ productVariant<br/>1 : N"| Offer
        Offer -->|"inventory ↔ offer<br/>1 : 1"| Inventory
        CatalogProduct -->|"tags ↔ catalogProducts<br/>N : N"| Tag
        CatalogProduct -->|"media ↔ owner<br/>1 : N"| Media
        ProductVariant -->|"media ↔ owner<br/>1 : N"| Media
        CatalogProduct -->|"reviews ↔ catalogProduct<br/>1 : N"| Review
        Review -->|"media ↔ owner<br/>1 : N"| Media
    end
    ...
    CatalogProduct -.->|"catalogProduct"| Wishlist
    ...
    class User,UserCredential,SocialCredential,Address,PointHistory,RefreshToken,BlacklistToken,BlacklistUser,SellerProfile identity
    class Category,CatalogProduct,ProductVariant,Offer,Inventory,Tag,Media,Review,Wishlist catalog
